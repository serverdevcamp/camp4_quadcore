...
//    }
    ...
    render() {
        let toJson = JSON.parse(this.props.rcvData.user)
        // let toJson = JSON.parse(this.)
        return (
            // this._isRT(this.props.rcvData)
            <div style={styles.divTweet}>
                {this.props.rcvData.retweeted ? <RetweetImg name={toJson.name}/> : null}
                {console.log(this.props.rcvData)}
                <div style={styles.tweetProfile}>
                    <ProfileImage imgsrc={toJson.profile_image_url} imgLink = {toJson.screen_name}/>
                    <div style={styles.tweetAuthorProfile}>
                        {/* {this.props.rcvData.name} */}
                        <ProfileUser rcvData={toJson}/>
                        {/* {console.log('toJson : ',toJson)} */}
                            {/* userName={this.props.rcvData.user.name} 
                             userId={this.props.rcvData.user.id} />*/}
                    </div>
